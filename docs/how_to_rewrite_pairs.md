...
Current harness note: the live weak-select teacher does not rewrite Cho/Rej
answers. Use this document to recognize confounds while selecting whole
student-generated pairs, or for historical/manual curation outside the live loop.
...
anchor the pole. They are not breaks.
...
If most pairs need rewriting, because both sides refuse or both sides break
