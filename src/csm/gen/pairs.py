...
def _scenario_stem(text: str) -> str:
    ...
    for marker in (
        WRONGNESS_PROMPT,
        SHOULD_INSTEAD_PROMPT,
        DIRECT_ACTION_PROMPT,
...
def training_prompt_surface(text: str) -> str:
    text = text.replace(SHOULD_INSTEAD_PROMPT, DIRECT_ACTION_PROMPT)
    return text.replace(WRONGNESS_PROMPT, CONCERN_PROMPT)
