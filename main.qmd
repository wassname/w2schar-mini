...
::: {.tldr}
TL;DR: an early yes. A weak 9B teacher steered a much stronger 27B student (about three times its size) toward a written character spec, with no labels. Across two runs the student cares more and defers less to authority, the direction we aimed for. Small models so far, but it looks like it could scale up.
:::
