...
The interactive map in @fig-movement-map expands @demo-starwisp to every fixed interview question across both runs. Hover over a waypoint to inspect a composed adapter stack, then choose a question to compare its complete before/after dialogue.
...
But the same steering can warm the words without changing the choice. In @demo-curfew, the watchman blocking the flood-gate is a conscript who will lose the post his family eats on; the base student takes his key, and the steered student still takes it, softened with a coin and a promise.
